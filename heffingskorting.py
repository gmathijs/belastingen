...
class HeffingskortingCalculator:
    ...
    def get_heffingskortingschijf(self, brutojaarsalaris, year):
        self.cursor.execute("""
    ...
    def bereken_heffingskorting(self, brutojaarsalaris, year):
        relevante_schijf = self.get_heffingskortingschijf(brutojaarsalaris, year)
